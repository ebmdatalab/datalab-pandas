...
class MapLoader():
    ...
    def __init__(self, description=None, author="EBM DataLab"):
    ...
    def create_map_with_london_sep(self, plot_value, title, description=None,
                   size=(12, 10),
                   cmap="OrRd",
                   legend=True, fit_legend=False,
                   edgecolor="black", linewidth=0.1, save=False):
        """
        create plot with london separate
    ...
    def create_map(self, plot_value, title,
                            description=None,
                            size=(12, 10),
                            cmap="OrRd",
                            legend=True,
                            ...
                            **kwargs):
        """
        creates a plot of England but with london not separate
